    ...
    <body>
        ...
        <table border="2px" style="border-collapse: collapse; color: white;">
            <tr>
                ...
                <td style="font-weight:bold;" id="smallPadding"><?php echo $song_Title;?></td>
            </tr>
            <tr>
        ...
        <?php
            ...
            $pass = ""; //database pwd
            $db = "zootopia_songdb"; //database name
            ...
            {
                $sql = "INSERT INTO SONG (songTitle, artistBandName, audioVideoLink, genre, language, releaseDate, status, uploader) VALUES ('".$song_Title."','".$artistBandName."','".$audioVideoLink."','".$genre."','".$language."','".$releaseDate."','".$status."','".$_SESSION["userName"]."');";
